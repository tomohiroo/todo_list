...
let getBabelConfig = (() => {
  var _ref3 = _asyncToGenerator(function* (asset) {
    ...
    let babelrc = yield getBabelRc(asset);
    let envConfig = yield getEnvConfig(asset, !!babelrc);
...
let getBabelRc = (() => {
  ...
  return function getBabelRc(_x4) {
...
let findBabelRc = (() => {
  ...
  return function findBabelRc(_x5) {
...
let getEnvConfig = (() => {
  var _ref6 = _asyncToGenerator(function* (asset, isSourceModule) {
    ...
    let targetEnv = yield getEnvPlugins(targetEngines);
    if (!targetEnv) {
      return null;
    }
    ...
    if (asset.name.includes(NODE_MODULES) && !isSourceModule) {
      ...
      let sourceEnv = (yield getEnvPlugins(sourceEngines)) || targetEnv;
  ...
  return function getEnvConfig(_x6, _x7) {
    return _ref6.apply(this, arguments);
  };
})();

let getEnvPlugins = (() => {
  var _ref7 = _asyncToGenerator(function* (targets) {
    if (!targets) {
      return null;
    }
  ...
  return function getEnvPlugins(_x8) {
